...
class Question13: UIViewController {
    ...
    @IBOutlet weak var Question13: UILabel!
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = UIColor(red: CGFloat(51)/255, green: CGFloat(204)/255, blue: CGFloat(0)/255, alpha: CGFloat(1.0)/255)
        Question13.sizeToFit()
        name.text = player1Name
        name2.text = player2Name
        name.sizeToFit()
        name2.sizeToFit()
        Question13.lineBreakMode = NSLineBreakMode.ByWordWrapping
        Question13.center.x = self.view.bounds.width/2
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        UIView.animateWithDuration(0.3, delay: 2.5, options: [], animations: {self.Question13.alpha += 1}, completion: nil)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if(segue.identifier == "segueChangeQ14"){
            let svc = segue.destinationViewController as! Question14;
