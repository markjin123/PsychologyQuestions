...
class Question14: UIViewController {
    ...
    @IBOutlet weak var Question14: UILabel!
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = UIColor(red: CGFloat(0)/255, green: CGFloat(230)/255, blue: CGFloat(230)/255, alpha: 1.0)
        Question14.center.x = self.view.bounds.width/2
        Question14.lineBreakMode = NSLineBreakMode.ByWordWrapping
        Question14.sizeToFit()
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        UIView.animateWithDuration(0.3, delay: 2.5, options: [], animations: {self.Question14.alpha += 1}, completion: nil)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if(segue.identifier == "segueChangeQ15"){
            let svc = segue.destinationViewController as! Question15;
