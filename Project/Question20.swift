...
class Question20: UIViewController {
    ...
    @IBOutlet weak var Question20: UILabel!
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = UIColor(red: CGFloat(153)/255, green: CGFloat(204)/255, blue: CGFloat(0), alpha: 1.0)
        Question20.sizeToFit()
        name.text = player1Name
        name2.text = player2Name
        name.sizeToFit()
        name2.sizeToFit()
        Question20.lineBreakMode = NSLineBreakMode.ByWordWrapping
        Question20.center.x = self.view.bounds.width/2
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        UIView.animateWithDuration(0.3, delay: 2.5, options: [], animations: {self.Question20.alpha += 1}, completion: nil)
