...
class Question12: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        Question12.center.x = self.view.bounds.width/2
        Question12.lineBreakMode = NSLineBreakMode.ByWordWrapping
        Question12.sizeToFit()
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        UIView.animateWithDuration(0.3, delay: 2.5, options: [], animations: {self.Question12.alpha += 1}, completion: nil)
