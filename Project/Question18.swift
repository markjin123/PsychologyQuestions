...
class Question18: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = UIColor(red: CGFloat(255)/255, green: CGFloat(77)/255, blue:CGFloat(166)/255, alpha: 1.0)
        Question18.sizeToFit()
        name.text = player1Name
        name2.text = player2Name
        name.sizeToFit()
        name2.sizeToFit()
        Question18.lineBreakMode = NSLineBreakMode.ByWordWrapping
        Question18.center.x = self.view.bounds.width/2
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        UIView.animateWithDuration(0.3, delay: 2.5, options: [], animations: {self.Question18.alpha += 1}, completion: nil)
