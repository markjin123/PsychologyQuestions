...
class Question25: UIViewController {
    ...
    @IBOutlet weak var Question25: UILabel!
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = UIColor(red: CGFloat(255)/255, green: CGFloat(104)/255, blue: CGFloat(204)/255, alpha: 1.0)
        Question25.center.x = self.view.bounds.width/2
        Question25.sizeToFit()
        name.text = player1Name
        name2.text = player2Name
        name.sizeToFit()
        name2.sizeToFit()
        Question25.lineBreakMode = NSLineBreakMode.ByWordWrapping
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        UIView.animateWithDuration(0.3, delay: 2.5, options: [], animations: {self.Question25.alpha += 1}, completion: nil)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if(segue.identifier == "segueChangeQ26"){
            let svc = segue.destinationViewController as! Question26;
