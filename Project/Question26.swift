...
class Question26: UIViewController {
    ...
    @IBOutlet weak var Question26: UILabel!
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = UIColor(red: CGFloat(77)/255, green: CGFloat(166)/255, blue: CGFloat(255)/255, alpha: 1.0)
        Question26.sizeToFit()
        name.text = player1Name
        name2.text = player2Name
        name.sizeToFit()
        name2.sizeToFit()
        Question26.lineBreakMode = NSLineBreakMode.ByWordWrapping
        Question26.center.x = self.view.bounds.width/2
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        UIView.animateWithDuration(0.3, delay: 2.5, options: [], animations: {self.Question26.alpha += 1}, completion: nil)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if(segue.identifier == "segueChangeQ27"){
            let svc = segue.destinationViewController as! Question27;
