...
class Question22: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = UIColor(red: CGFloat(0), green: CGFloat(204)/255, blue: CGFloat(153)/255, alpha: 1.0)
        
        Question22.sizeToFit()
        name.text = player1Name
        name2.text = player2Name
        name.sizeToFit()
        name2.sizeToFit()
        Question22.lineBreakMode = NSLineBreakMode.ByWordWrapping
        Question22.center.x = self.view.bounds.width/2
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        UIView.animateWithDuration(0.3, delay: 2.5, options: [], animations: {self.Question22.alpha += 1}, completion: nil)
