...
class Question7: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = UIColor(red: CGFloat(255), green: CGFloat(128)/255, blue: CGFloat(255), alpha: 1.0)
        Question7.center.x = self.view.bounds.width/2
        Question7.lineBreakMode = NSLineBreakMode.ByWordWrapping
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        UIView.animateWithDuration(0.3, delay: 2.5, options: [], animations: {self.Question7.alpha += 1}, completion: nil)
