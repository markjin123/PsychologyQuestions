...
class Question28: UIViewController {
    ...
    @IBOutlet weak var Question28: UILabel!
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = UIColor(red: CGFloat(0), green: CGFloat(230)/255, blue: CGFloat(230)/255, alpha: 1.0)
        Question28.center.x = self.view.bounds.width/2
        Question28.sizeToFit()
        name.text = player1Name
        name2.text = player2Name
        name.sizeToFit()
        name2.sizeToFit()
        Question28.lineBreakMode = NSLineBreakMode.ByWordWrapping
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        UIView.animateWithDuration(0.3, delay: 2.5, options: [], animations: {self.Question28.alpha += 1}, completion: nil)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if(segue.identifier == "segueChangeQ29"){
            let svc = segue.destinationViewController as! Questions29;
