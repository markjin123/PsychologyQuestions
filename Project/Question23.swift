...
class Question23: UIViewController {
    ...
    @IBOutlet weak var Question23: UILabel!
    ...
    override func viewDidLoad() {
        ...
        Question23.sizeToFit()
        name.text = player1Name
        name2.text = player2Name
        name.sizeToFit()
        name2.sizeToFit()
        Question23.lineBreakMode = NSLineBreakMode.ByWordWrapping
        Question23.center.x = self.view.bounds.width/2
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        UIView.animateWithDuration(0.3, delay: 2.5, options: [], animations: {self.Question23.alpha += 1}, completion: nil)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if(segue.identifier == "segueChangeQ24"){
            let svc = segue.destinationViewController as! Question24;
