...
class Question24: UIViewController {
    ...
    @IBOutlet weak var Question24: UILabel!
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = UIColor(red: CGFloat(191)/255, green: CGFloat(0), blue: CGFloat(255)/255, alpha: 1.0)
        Question24.center.x = self.view.bounds.width/2
        Question24.sizeToFit()
        name.text = player1Name
        name2.text = player2Name
        name.sizeToFit()
        name2.sizeToFit()
        Question24.lineBreakMode = NSLineBreakMode.ByWordWrapping
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        UIView.animateWithDuration(0.3, delay: 2.5, options: [], animations: {self.Question24.alpha += 1}, completion: nil)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if(segue.identifier == "segueChangeQ25"){
            let svc = segue.destinationViewController as! Question25;
