...
class Question27: UIViewController {
    ...
    @IBOutlet weak var Question27: UILabel!
    ...
    override func viewDidLoad() {
        ...
        self.view.backgroundColor = UIColor(red: CGFloat(255)/255, green: CGFloat(153)/255, blue: CGFloat(153)/255, alpha: 1.0)
        Question27.sizeToFit()
        name.text = player1Name
        name2.text = player2Name
        name.sizeToFit()
        name2.sizeToFit()
        Question27.lineBreakMode = NSLineBreakMode.ByWordWrapping
        Question27.center.x = self.view.bounds.width/2
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        NSTimer.scheduledTimerWithTimeInterval(2.8, target: self, selector: ("timerInit:"), userInfo: nil, repeats: false)
        ...
        UIView.animateWithDuration(0.3, delay: 2.5, options: [], animations: {self.Question27.alpha += 1}, completion: nil)
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        if(segue.identifier == "segueChangeQ28"){
            let svc = segue.destinationViewController as! Question28;
